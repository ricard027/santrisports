  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 z-50 flex h-full  justify-end ">
        <div className="relative z-50 flex h-full w-[80vw] flex-col justify-evenly bg-[#f0f0f0]  opacity-100 sm:w-[400px]">
          {/** Cart Title */}
          ...
          {/** Cart Title */}
          {/** Cart List*/}
          <ul className="custom-scrollbar m-auto mb-6 h-96 w-[80%] overflow-y-scroll">
            <li className="my-5 flex w-[100%] flex-auto items-center justify-start gap-4 rounded bg-white p-4 shadow-xl">
