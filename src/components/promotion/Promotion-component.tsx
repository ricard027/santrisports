...
const PromoComponent = () => {
  return (
    <>
      ...
      <section className="flex flex-col flex-wrap items-center justify-between gap-4 sm:flex-row ">
        <div className="active-button-on-hover  relative flex h-[300px] w-full flex-1 flex-col items-center justify-center gap-2 bg-customgray sm:h-full">
          <img
            src="https://i.pinimg.com/564x/b7/c5/c3/b7c5c3d791c3ae83cda6e6ad09cbea81.jpg"
            alt="Roupa promo feminina"
